...
// Budgeted drain cleanup regression cases.
#[path = "health_regression_tests/budgeted.rs"]
mod budgeted;
// Backlog convergence and pruning regression cases.
#[path = "health_regression_tests/convergence.rs"]
mod convergence;
